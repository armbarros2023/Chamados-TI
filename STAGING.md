...
- VPS: ambiente de staging autorizado.
...
O domínio corporativo `chamados-staging.arbtechinfo.com.br` é o endereço principal. O endereço temporário de contingência permanece somente na documentação operacional privada.
...
Destino: VPS de staging autorizada
```
